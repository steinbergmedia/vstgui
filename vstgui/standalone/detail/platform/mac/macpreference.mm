...
{
	[[NSUserDefaults standardUserDefaults] setObject:stringFromUTF8String (value) forKey:stringFromUTF8String (key)];
	return true;
}
...
{
	NSString* value = [[NSUserDefaults standardUserDefaults] stringForKey:stringFromUTF8String(key)];
	if (value != nil)
