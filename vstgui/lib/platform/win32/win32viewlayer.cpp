...
{
	visual->update (size, [&] (auto deviceContext, auto updateRect, auto offsetX, auto offsetY) {
...
{
	visual->setPosition (size.left, size.top);
	visual->resize (size.getWidth (), size.getHeight ());
	viewSize = size;
	viewSize.originize ();
