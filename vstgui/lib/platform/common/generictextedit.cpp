...
// key-bindings
#define STB_TEXTEDIT_K_LEFT (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Left))
#define STB_TEXTEDIT_K_RIGHT (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Right))
#define STB_TEXTEDIT_K_UP (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Up))
#define STB_TEXTEDIT_K_DOWN (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Down))
#if MAC
...
#else
#define STB_TEXTEDIT_K_LINESTART (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Home))
#define STB_TEXTEDIT_K_LINEEND (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::End))
#	define STB_TEXTEDIT_K_WORDLEFT (STB_TEXTEDIT_K_LEFT | STB_TEXTEDIT_K_CONTROL)
#	define STB_TEXTEDIT_K_WORDRIGHT (STB_TEXTEDIT_K_RIGHT | STB_TEXTEDIT_K_CONTROL)
#	define STB_TEXTEDIT_K_TEXTSTART (STB_TEXTEDIT_K_LINESTART | STB_TEXTEDIT_K_CONTROL)
#	define STB_TEXTEDIT_K_TEXTEND (STB_TEXTEDIT_K_LINEEND | STB_TEXTEDIT_K_CONTROL)
#endif
#define STB_TEXTEDIT_K_DELETE (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Delete))
#define STB_TEXTEDIT_K_BACKSPACE (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Back))
...
#define STB_TEXTEDIT_K_INSERT (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::Insert))
#define STB_TEXTEDIT_K_PGUP (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::PageUp))
#define STB_TEXTEDIT_K_PGDOWN (VIRTUAL_KEY_BIT | static_cast<uint8_t> (VirtualKey::PageDown))
// functions
